        ...
        <div class="row h-100 g-0">
            <div class="col-md-6">
                <div class="card card-span h-100 text-white"><img class="card-img h-100"
                        src="{{ template_frontpage('assets/img/gallery/summer.png') }}" alt="..." />
            ...
            <div class="col-md-6 h-100">
                <div class="row h-100 g-0">
                    <div class="col-md-6 h-100">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100"
                                src="{{ template_frontpage('assets/img/gallery/sunglasses.png') }}" alt="..." />
                            <div class="card-img-overlay bg-dark-gradient rounded-0">
                    ...
                    <div class="col-md-6">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100"
                                src="{{ template_frontpage('assets/img/gallery/footwear.png') }}" alt="..." />
                            <div class="card-img-overlay bg-dark-gradient rounded-0">
                                <div class="p-5 p-xl-5 p-md-0">
                    ...
                    <div class="col-md-6">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100"
                                src="{{ template_frontpage('assets/img/gallery/hat-black-border.png') }}"
                                alt="..." />
                            <div class="card-img-overlay bg-dark-gradient rounded-0">
                                <div class="p-5 p-xl-5 p-md-0">
                    ...
                    <div class="col-md-6">
                        <div class="card card-span h-100 text-white"><img class="card-img h-100"
                                src="{{ template_frontpage('assets/img/gallery/watches.png') }}" alt="..." />
                            <div class="card-img-overlay bg-dark-gradient rounded-0">
                                <div class="p-5 p-xl-5 p-md-0">
