<section class="py-11 bg-light-gradient border-bottom border-white border-5">
    <div class="bg-holder overlay overlay-light"
        style="background-image:url({{ template_frontpage('assets/img/gallery/header-bg.png') }});background-size:cover;">
    </div>
    <!--/.bg-holder-->
        ...
        <div class="row g-0">
            <div class="col-md-6">
                <div class="card card-span h-100 text-white"> <img class="img-fluid"
                        src="{{ template_frontpage('assets/img/gallery/her.png') }}" width="790" alt="..." />
            ...
            <div class="col-md-6">
                <div class="card card-span h-100 text-white"> <img class="img-fluid"
                        src="{{ template_frontpage('assets/img/gallery/him.png') }}" width="790" alt="..." />
                    <div class="card-img-overlay d-flex flex-center"> <a class="btn btn-lg btn-light" href="#!">For
                            Him </a></div>
                </div>
            </div>
