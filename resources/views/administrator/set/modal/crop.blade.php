    ...
    <script type="text/javascript">
        $('#ModalCrop').off().on('show.bs.modal', function(event) {
            ...
            var cropper = new Cropper(image, {
                ...
                data: {
                    width: triggerCrop.parent().find('.data_image-item').find('.width-item').val() !== '' ? parseInt(triggerCrop.parent().find('.data_image-item').find('.width-item').val()) : (triggerCrop.parent().find('.data_image-item').find('.ratio1-item').val() === 2 ? 400 :600),
                    height: triggerCrop.parent().find('.data_image-item').find('.height-item').val() !== '' ? parseInt(triggerCrop.parent().find('.data_image-item').find('.height-item').val()) : 600,
                    x: triggerCrop.parent().find('.data_image-item').find('.x-item').val() !== '' ? parseInt(triggerCrop.parent().find('.data_image-item').find('.x-item').val()) : 0,
                    y: triggerCrop.parent().find('.data_image-item').find('.y-item').val() !== '' ? parseInt(triggerCrop.parent().find('.data_image-item').find('.y-item').val()) : 0,
                },
            ...
            $('#selectDataCrop').off().on('click', function() {
                ...
                triggerCrop.parent().find('.data_image-item').find('.width-item').val(Math.round(cropper
                    .getData().width));
                triggerCrop.parent().find('.data_image-item').find('.height-item').val(Math.round(cropper
                    .getData().height));
                triggerCrop.parent().find('.data_image-item').find('.x-item').val(Math.round(cropper
                    .getData().x));
                triggerCrop.parent().find('.data_image-item').find('.y-item').val(Math.round(cropper
                    .getData().y));
                ...
                triggerCrop.parent().parent().find('.img-thumbnail-container canvas').addClass(
                    'img-thumbnail');
