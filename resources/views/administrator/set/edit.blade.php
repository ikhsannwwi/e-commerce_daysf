            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('admin.set.update') }}" method="post" enctype="multipart/form-data"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mandatory">
                                                    ...
                                                    <input type="text" id="namaField" class="form-control"
                                                        value="{{ $data->nama }}" placeholder="Masukan Nama"
                                                            ...
                                                            @foreach ($data->detail as $key => $row)
                                                                <tr class="detail-list" childidx="{{ $key }}"
                                                                    ...
                                                                    <input type="hidden" class="input_id-item"
                                                                        name="detail[{{ $key }}][id]"
                                                                        value="{{ $row->id }}">
                                                                    <td class="no-item text-center">{{ $key + 1 }}
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text"
                                                                                name="detail[{{ $key }}][produk]"
                                                                                class="form-control produk-item"
                                                                                value="{{ $row->nama }}"
                                                                                data-parsley-required="true"
                                                                                autocomplete="off"
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text"
                                                                                ...
                                                                                class="form-control text-end harga-item"
                                                                                value="Rp {{ number_format($row->harga, 0, ',', '.') }}"
                                                                                data-parsley-required="true"
                                                                                autocomplete="off"
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text"
                                                                                name="detail[{{ $key }}][link_pembelian]"
                                                                                class="form-control link_pembelian-item"
                                                                                value="{{ $row->link }}"
                                                                                data-parsley-required="true"
                                                                                autocomplete="off"
                                                                                placeholder="Masukan Link Pembelian">
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label for="inputImage_{{ $key }}"
                                                                                class="btn btn-light btn-file label_inputImage-item">
